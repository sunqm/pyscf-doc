...
Also enable the flag ``BUILD_MARCH_NATIVE`` at the step of calling cmake to
generate Makefile::

  cmake -DBUILD_MARCH_NATIVE=ON ..

This flag ensures the generated binary libraries using all possible CPU
instructions. Without this flag, only SSE3 instructions will be used.
